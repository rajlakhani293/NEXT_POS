...
function ProfileField({
  ...
  return (
    <div className="grid gap-2 py-3 last:border-b-0 md:grid-cols-[280px_minmax(0,1fr)] md:gap-x-16 md:items-start">
            ...
            <section className="py-5 px-10">
              ...
              <div>
                ...
                <ProfileField label="Company Name" required>
                  <UniFieldInput placeholder="Enter company name" required value={values.name} onChange={(e) => updateField("name", e.target.value)} />
                </ProfileField>
                <ProfileField label="Legal Name">
                  <UniFieldInput placeholder="Enter legal business name" value={values.legal_name} onChange={(e) => updateField("legal_name", e.target.value)} />
                </ProfileField>
                <ProfileField label="Email">
                  <UniFieldInput placeholder="Enter company email" type="email" value={values.email} onChange={(e) => updateField("email", e.target.value)} />
                </ProfileField>
                <ProfileField label="Phone">
                  <UniFieldInput placeholder="Enter company phone" value={values.phone} onChange={(e) => updateField("phone", e.target.value)} />
                </ProfileField>
                <ProfileField label="GST Number">
                  <UniFieldInput placeholder="Enter GST number" value={values.gst_number} onChange={(e) => updateField("gst_number", e.target.value)} />
                </ProfileField>
                <ProfileField label="City Name">
                  <UniFieldInput placeholder="Enter company city" value={values.city_name} onChange={(e) => updateField("city_name", e.target.value)} />
                </ProfileField>
                ...
                <ProfileField label="Address">
                  <UniFieldInput as="textarea" placeholder="Enter company address" value={values.address} onChange={(e) => updateField("address", e.target.value)} />
                </ProfileField>
              </div>
            </section>
          </div>
