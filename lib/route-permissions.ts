...
export const ROUTE_PERMISSIONS: RoutePermission[] = [
  ...
  { path: "/products/categories", permission: PERMISSIONS.products.view },
  { path: "/products/print-labels", permission: PERMISSIONS.products.view },
  { path: "/products/scale-range", permission: PERMISSIONS.inventory.adjust },
  { path: "/products", permission: PERMISSIONS.products.view },
  { path: "/units/groups", permission: PERMISSIONS.products.view },
  { path: "/units", permission: PERMISSIONS.products.view },
