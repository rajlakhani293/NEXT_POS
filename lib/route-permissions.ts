...
export const ROUTE_PERMISSIONS: RoutePermission[] = [
  ...
  { path: "/taxes/create", permission: PERMISSIONS.products.create },
  { path: "/taxes/edit", permission: PERMISSIONS.products.update },
  { path: "/taxes", permission: PERMISSIONS.products.view },
